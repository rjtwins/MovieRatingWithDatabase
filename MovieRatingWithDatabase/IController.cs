public interface IController
{
    ...
    /// <summary>
    /// Add a entry with given index in the search results display to the bookmarks database and display it.
    /// </summary>
    ...
    /// <summary>
    /// Used to notify implimenting class that the details display has been closed and any data input in there should be processed.
    /// </summary>
    /// <param name="r"></param>
